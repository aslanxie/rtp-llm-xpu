...
def _impl(ctx):
        ...
        flag_sets = [
            flag_set(
                ...
                flag_groups = [
                    ...
                    #
                    # Hardening flags disabled for XPU (icx/icpx compatibility TBD)
                    #
                    # flag_group(
                    #     flags = ["-fPIE"],
    ...
    # XPU/SYCL link flags: link against the SYCL runtime and Level Zero loader.
    # -fsycl is needed at link time to pull in libsycl and device binaries.
